...
Software Engineer with 3+ years building and operating **production-grade Apache Kafka and Confluent platforms** at A.P. Moller-Maersk. I own the full streaming platform lifecycle — cluster provisioning, version upgrades, Schema Registry governance, and self-service tooling — with a strong track record in **zero-downtime migrations**, **exactly-once semantics**, and **24x7 production reliability**.

Led a **Confluent-to-Apache Kafka migration** delivering 15% cost reduction with zero data loss.
...
| Domain | Skills |
|---|---|
| **Kafka & Streaming** | Apache Kafka · Confluent Platform · Event-Driven Architecture · Kafka Connect · Kafka Streams · Schema Registry · MirrorMaker 2 · KRaft · Exactly-Once Semantics · Schema Evolution · Multi Region |
| **Cluster Operations** | Broker/Partition/Replication Mgmt · Version Upgrades · Cluster Lifecycle · Capacity Planning · Consumer Group Tuning · Performance Testing |
| **Platform & Infra** | Kubernetes · Strimzi Operator · Docker · FluxCD · GitOps · GitHub Actions · CI/CD · Azure · GCP · VMware Engine (on-prem) |
| **Reliability & Sec** | Prometheus · Grafana · PagerDuty/On-Call · Incident Response · DORA Metrics · TLS/mTLS · HashiCorp Vault |
| **Languages** | GoLang · Python · Java (SMTs) · Bash · REST APIs |
